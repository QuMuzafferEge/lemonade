...
Please see the general [contribution guidelines](../contribute.md), then contact @jfowers_amd on Discord before getting started to discuss the roadmap.
...
- [ ] Migrate LMX model definitions to Hugging Face to make them searchable as models. Make sure Lemonade is shown under Use This Model on the model card.
